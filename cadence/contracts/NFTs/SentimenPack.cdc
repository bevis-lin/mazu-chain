...
pub contract SentimenPack: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT {
        ...
        init(_packNumber: UInt64, _packType: UInt64) {
            let packTypeStruct: &PackType = &SentimenPack.packTypes[_packType] as &PackType
            ...
            self.id = SentimenPack.totalSupply
            self.packInfo = PackInfo(_packNumber: _packNumber, _packType: _packType)

            SentimenPack.totalSupply = SentimenPack.totalSupply + (1 as UInt64)
    ...
    pub resource interface IPackCollectionPublic {
        ...
        pub fun borrowPack(id: UInt64): &SentimenPack.NFT? {
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, IPackCollectionPublic, IPackCollectionAdminAccessible  {
        ...
        //
        pub fun deposit(token: @NonFungibleToken.NFT) {
            let token <- token as! @SentimenPack.NFT
        ...
        pub fun borrowPack(id: UInt64): &SentimenPack.NFT? {
            if self.ownedNFTs[id] != nil {
                ...
                return ref as! &SentimenPack.NFT
            } else {
                return nil
            }
        }
