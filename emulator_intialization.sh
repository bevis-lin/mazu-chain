...
flow transactions send ./cadence/transactions/AddCreator.cdc "0x01cf0e2f2f715450" "yangba" "bevis.tw@gmail.com" "http://www.digi96.ccom" "{\"facebook\":\"bevislin\",\"instagram\":\"bevislin\"}" --signer=emulator-account